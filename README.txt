The code is written in Java by Dan Hou.
...
You can build the project with: javac *.java
And run the project with: java EventFinder
Then follow the instruction finding the five closest events with a user location input.
